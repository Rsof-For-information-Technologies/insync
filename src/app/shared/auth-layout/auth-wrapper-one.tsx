    ...
    <>
      ...
      <div className="min-h-screen justify-between gap-x-8 px-4 py-8 pt-10 md:pt-12 lg:flex lg:p-6 xl:gap-x-10 xl:p-7 2xl:p-10 2xl:pt-10 [&>div]:min-h-[calc(100vh-80px)]">
        <div className="relative w-full">
          <div className=" w-full max-w-sm md:max-w-md 2xl:w-[630px] 2xl:max-w-none">
            {/* <Link
              href={'/'}
            ...
            <div className="mb-7 px-6 pt-3 text-center md:pt-0 lg:px-0 lg:text-start xl:mb-8 2xl:mb-10">
              <Link
                href={'/'}
                className="mb-6 inline-flex w-[200px] xl:mb-8"
              >
                <Image src={"/insync-logo-02.png"} alt="Insync" width={200} height={200} />
              </Link>
              <Title
                as="h2"
        ...
        <div className="hidden w-6/12 items-center justify-center rounded-[20px] bg-gray-50 px-6 lg:flex xl:justify-start 2xl:px-16 dark:bg-gray-100/40">
