                ...
                isOpen && (
                    <>
                        ...
                        <div className="z-[100] rounded-lg px-[24px] max-w-[600px] w-full absolute bg-white top-1/2 left-1/2 transform -translate-x-1/2 shadow-md">
                            <h3 className="py-[16px] dark:text-black">{t('createButton')}</h3>
                            ...
                            <div className="pb-[8px] flex justify-end item-center">
                                <button onClick={closeModal} className="py-[9px] px-[16px] font-semibold hover:bg-gray-50 rounded-lg mr-[5px] dark:text-black">{t('nextButton')}</button>
                                <button onClick={nextButton} className="py-[9px] px-[16px] font-semibold rounded-lg text-white bg-black">{t('cancelButton')}</button>
                            </div>
                        </div>
                    </>
                )
