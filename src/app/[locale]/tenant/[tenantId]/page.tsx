        ...
        <Authenticate >
            <Authorize allowedRoles={[UserRole.SuperAdmin, UserRole.Admin]} navigate={true}>
                <div className="flex flex-col space-y-6">
                    {/* Header Section */}
                    <Header title={t('title')} description={t('description') } icon={<ArrowLeft size={18} />} btnText="Back to List" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="flex flex-col p-5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h6 className="font-semibold text-gray-800 dark:text-white">ID</h6>
                                </div>
                            ...
                            <div className="flex flex-col p-5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h6 className="font-semibold text-gray-800 dark:text-white">Name</h6>
                                </div>
                            ...
                            <div className="flex flex-col p-5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h6 className="font-semibold text-gray-800 dark:text-white">Status</h6>
                                </div>
                            ...
                            <div className="flex flex-col p-5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h6 className="font-semibold text-gray-800 dark:text-white">Created at</h6>
                                </div>
                            ...
                            <div className="flex flex-col p-5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h6 className="font-semibold text-gray-800 dark:text-white">Updated at</h6>
                                </div>
                                <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300 pl-11">
                                    <Calendar size={16} />
