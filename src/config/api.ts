...
export const tenantApiCall = () => {
  const instance = axios.create({
    baseURL: process.env.NEXT_PUBLIC_TENANT_URL,
  });
...
export const connectApiCall = () => {
  const instance = axios.create({
    baseURL: process.env.NEXT_PUBLIC_CONNECT_URL,
  });
...
export const channelHubApiCall = () => {
  const instance = axios.create({
    baseURL: process.env.NEXT_PUBLIC_CHANNELHUB_BASE_URL,
  });
